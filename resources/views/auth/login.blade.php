                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="email" 
                                   ...
                                   class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200 ease-in-out"
            ...
            <div class="mt-8 text-center">
                <div class="grid grid-cols-3 gap-4">
                    <div class="text-center">
                        ...
                        <p class="mt-2 text-xs text-gray-600">AI Powered</p>
                    </div>
                    <div class="text-center">
                        ...
                        <p class="mt-2 text-xs text-gray-600">Secure</p>
                    </div>
                    <div class="text-center">
                        ...
                        <p class="mt-2 text-xs text-gray-600">Fast</p>
                    </div>
                </div>
            </div>
        </div>
